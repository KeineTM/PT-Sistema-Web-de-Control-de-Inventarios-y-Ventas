...
<form class="formulario" method="post" id="formulario-personal">
    <fieldset class="formulario__fieldset">
        ...
        <input type="text" class="campo requerido" placeholder="Apellido paterno" name="apellido_paterno-txt" autocomplete="off" data-form="apellido_paterno" minlength="3" maxlength="80" required>
    
        <label for="apellido_materno-txt">Apellido Materno:</label>
        <input type="text" class="campo requerido" placeholder="Apellido materno" name="apellido_materno-txt" autocomplete="off" data-form="apellido_materno" maxlength="80">

        <label for="telefono-txt">Teléfono:</label>
        <input type="number" step="any" class="campo requerido" placeholder="1234567890" name="telefono-txt" autocomplete="off" data-form="telefono" minlength="10" maxlength="10" required>

        <label for="rfc-txt">RFC:</label>
        <input type="text" class="campo mayusculas requerido" placeholder="ABCD123456EF0" name="rfc-txt" autocomplete="off" data-form="rfc" minlength="13" maxlength="13" required>
    ...
    <fieldset class="formulario__fieldset">
        ...
        <textarea name="notas-txt" class="campo" autocomplete="off" cols="30" rows="3" data-form="notas" placeholder="Notas..." maxlength="250"></textarea>
