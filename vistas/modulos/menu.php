...
<aside class="menu-contenedor">
    <nav class="menu" id="menu">
        <div class="menu-control">
            <a href="#menu" class="desplegar"><img class="flecha" src="vistas/img/chevron-down.svg" alt="Abrir menú"></a>
            <a href="#" class="colapsar"><img class="flecha" src="vistas/img/chevron-up.svg" alt="Cerrar menú"></a>
        </div>
        ...
        <ul class="menu-lista">
            ...
            <?php if($usuarioLogeado['tipo_usuario'] === 'Administrador') echo ('
